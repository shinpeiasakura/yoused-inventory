...
export default function ProductCard({ product, color, onEdit, onDelete, onUpdateStock, onUpdatePhoto, isReordering, isFirst, isLast, onMoveUp, onMoveDown }) {
                ...
                <div className="flex-shrink-0 flex flex-col gap-0.5">
                  <button
                    ...
                    className={`w-8 h-8 flex items-center justify-center transition-colors ${
                      isFirst ? 'text-[#DDD5C5] cursor-default' : 'text-[#7A6858] active:text-[#2C1A0E] active:bg-[#EDE7DA]'
                    }`}
                    style={{ borderRadius: '2px' }}
                    aria-label="上へ移動"
                  >
                  ...
                  <button
                    ...
                    disabled={isLast}
                    className={`w-8 h-8 flex items-center justify-center transition-colors ${
                      isLast ? 'text-[#DDD5C5] cursor-default' : 'text-[#7A6858] active:text-[#2C1A0E] active:bg-[#EDE7DA]'
                    }`}
                    style={{ borderRadius: '2px' }}
                    aria-label="下へ移動"
                  >
